...
export class FlutterwaveService {
    ...
    async createRecipient(dto: CreateRecipientDto): Promise<{ id: string;[key: string]: any }> {
    ...
    async initiateTransfer(dto: InitiateTransferDto): Promise<{ id: string;[key: string]: any }> {
